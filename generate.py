...
def main(parser):
    ...
    custom_oov_word = o.oov_word
    vocab[custom_oov_word] = numpy.max(list(vocab.values()))+1
...
sequences or word sequences only.
    ...
    parser.add_argument('--dtype',
                      ...
                      default='int32')
    parser.add_argument('--oov-word',
                      help='default codename for unknown word is <unk> but it may exist in the dataset',
                      default='<unk>')
    return parser
